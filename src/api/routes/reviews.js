...
router.get('/:id', (req, res, next) => {
  ...
  db.query(singleReviewQuery, [reviewID, reviewID, reviewID], (err, data) => {
    ...
    (data[0].comments) ? data[0].comments.sort((a, b) => (parseInt(a.comment_date) < parseInt(b.comment_date)) ? 1 : -1) : null;
