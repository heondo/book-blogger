    ...
    <Container style={{ display: "flex", justifyContent: "center" }}>
      <form onSubmit={submitNewUser}>
        <Grid
          ...
          xs={8}
          spacing={1}
          className={classes.spacingNavFirst}
          style={{ margin: "auto" }}
        >
          <Grid item xs={6}>
            <FormControl style={{ width: "100%" }}>
              <InputLabel htmlFor="firstInput">First</InputLabel>
              <Input
                id="firstInput"
              ...
              {!validInputs.firstInput ? (
                <FormHelperText id="first-helper">
            ...
            <FormControl style={{ width: "100%" }}>
              ...
              {!validInputs.emailInput ? (
                <FormHelperText id="email-helper">
                  {emailDuplicate ? "Email already taken" : "Invalid email"}
                </FormHelperText>
              ) : (
                <FormHelperText id="email-helper">
          ...
          <Grid item xs={12}>
            <FormControl style={{ width: "100%" }}>
              ...
              <Input
                ...
                aria-describedby="passwordInputText"
                type="password"
                onChange={handleInputChange}
              />
              {!validInputs.passwordInput ? (
                <FormHelperText id="password-helper">
                  Not long enough or no match
                </FormHelperText>
              ) : undefined}
            </FormControl>
          </Grid>
          <Grid item xs={12}>
            <FormControl style={{ width: "100%" }}>
              ...
              <Input
                ...
                aria-describedby="confirmPasswordInputText"
                onChange={handleInputChange}
              />
